...
graph LR
    subgraph Phase1["Phase 1 — Foundation"]
        direction LR
        P1A["Control 5: Restrict Admin Privileges</br>(Critical path)"]
        P1B["Control 8: Regular Backups</br>(Independent start)"]
        P1C["Control 7: MFA</br>(Start after week 2 of Control 5)"]
    end

    subgraph Phase2["Phase 2 — Prevention"]
        direction LR
        P2A["Control 6: Patch Operating Systems</br>(Primary track)"]
        P2B["Control 2: Patch Applications</br>(Start after week 2 of Control 6)"]
    end

    subgraph Phase3["Phase 3 — Hardening"]
        direction LR
        P3A["Control 1: Application Control</br>(After patching stable)"]
        P3B["Control 3: Configure Macro Settings</br>(Independent start)"]
        P3C["Control 4: User Application Hardening</br>(Independent start)"]
    end
