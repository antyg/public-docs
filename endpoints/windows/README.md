...
| -------------------------------- | ------------------------------------------------------------------------- | ----------- | ------- |
| Windows Management Concepts      | [explanation-windows-management.md](explanation-windows-management.md)    | Explanation | Planned |
| Windows Settings Reference       | [reference-windows-settings.md](reference-windows-settings.md)            | Reference   | Planned |

### Windows Management Concepts

Seed outline covering the key Windows endpoint management mechanisms in Intune:
Configuration Profiles and Settings Catalogue, Compliance Policies (BitLocker,
TPM, OS version, Health Attestation), Security Baselines (Windows, Defender for
Endpoint, Edge, M365 Apps), Windows Update for Business (update rings, feature
update policies, Autopatch), Group Policy Migration (Group Policy Analytics,
GPO-to-Settings-Catalogue migration), and Endpoint Privilege Management (LAPS,
EPM elevation rules).

### Windows Settings Reference

Seed outline covering Windows settings lookup material: Settings Catalogue
category map, ADMX-backed policy reference, compliance policy settings matrix,
security baseline versions and settings reference, and Windows Update ring
...
| ---------------------------- | ---------------- | ---------------------- |
| Device syslog capture        | Yes              | Yes                    |
| MDM profile snapshots        | Yes              | Yes                    |
| ZCC log extraction           | Yes              | Yes                    |
| Network packet capture (RVI) | Not available    | Yes — full device traffic |
