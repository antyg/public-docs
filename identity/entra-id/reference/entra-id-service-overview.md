...
This document is a factual reference for Microsoft Entra ID service capabilities, licence tiers, supported identity types, authentication protocols, and key API endpoints. It does not contain configuration instructions — those are in the `../how-to/` subfolder.
