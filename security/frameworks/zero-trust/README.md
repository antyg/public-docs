...
| File | Description |
|------|-------------|
| [explanation-zero-trust-principles.md](explanation-zero-trust-principles.md) | Core Zero Trust principles, the three foundations, and six pillars |
| [how-to-implement-zero-trust-pillars.md](how-to-implement-zero-trust-pillars.md) | Implementation guidance across the six Zero Trust pillars |
| [reference-zero-trust-maturity.md](reference-zero-trust-maturity.md) | Zero Trust maturity model — Traditional, Advanced, and Optimal stages |
| [tutorial-getting-started-with-zero-trust.md](tutorial-getting-started-with-zero-trust.md) | Guided introduction to Zero Trust for newcomers |
