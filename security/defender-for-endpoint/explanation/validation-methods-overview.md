...
|--------|-------|---------------|-------|-----------------|
| [PowerShell (local/remote)](../tutorials/powershell-validation.md) | Single device / bulk CSV | Windows auth (WinRM) | Fast | Domain environments, bulk validation |
| [Microsoft Graph Security API](../tutorials/graph-api-validation.md) | Organisation-wide | App registration (OAuth 2.0) | Medium | Centralised reporting, automation |
