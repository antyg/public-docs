...
- **[azure-firewall/](azure-firewall/)**: Azure Firewall traffic architecture, routing configuration, NSG integration, troubleshooting (draft)
- **[expressroute/](expressroute/)**: ExpressRoute routing architecture, hub-and-spoke integration, routing requirements reference (draft + planned)
- **[dns/](dns/)**: Hybrid DNS architecture, Azure DNS zones reference — structured seed outlines for future content (planned)
- **[vpn/](vpn/)**: VPN gateway architecture, gateway configuration reference — structured seed outlines for future content (planned)
