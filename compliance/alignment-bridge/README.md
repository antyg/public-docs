...
| `explanation-mapping-methodology.md` | How alignment guides are constructed — control decomposition, evidence mapping, citation standards |
| `explanation-maintenance-guidelines.md` | How alignment content is kept current as frameworks and products evolve |
