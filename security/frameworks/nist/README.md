...
| File | Description |
|------|-------------|
| [explanation-nist-csf-evolution.md](explanation-nist-csf-evolution.md) | Evolution of the NIST Cybersecurity Framework from CSF 1.1 to CSF 2.0 |
| [how-to-map-nist-to-azure.md](how-to-map-nist-to-azure.md) | Mapping NIST CSF functions and controls to Azure and Microsoft 365 |
| [reference-nist-csf-functions.md](reference-nist-csf-functions.md) | Reference for the five NIST CSF core functions and their categories |
| [tutorial-getting-started-with-nist-csf.md](tutorial-getting-started-with-nist-csf.md) | Guided introduction to the NIST Cybersecurity Framework |
...
3. **Implement compliance** — `../../../compliance/nist/entra-id/` (planned) provides step-by-step configuration to meet specific AC controls
