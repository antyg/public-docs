...
Complete the identity pillar (covered in [Getting Started with Zero Trust](tutorial-getting-started-with-zero-trust.md)) before beginning the other pillars — identity verification is the prerequisite for all Zero Trust access decisions.
...
**Status**: Covered in [Getting Started with Zero Trust](tutorial-getting-started-with-zero-trust.md). Key controls:
