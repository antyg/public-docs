...
| File | Description |
|------|-------------|
| [reference-control-technology-mapping.md](reference-control-technology-mapping.md) | Maps all eight Essential Eight controls to Microsoft technology implementations, licensing requirements, and infrastructure prerequisites |

---

## Planned Alignment Guides

Per-strategy alignment guides with maturity-level-specific configuration guidance are planned for future authoring:

> The subdirectories below are planned content that has not yet been created.

```
essential-eight-alignment/
├── README.md                          ← This file (scope, methodology, overview)
├── reference-control-technology-mapping.md  ← Control-to-technology mapping (current)
│
