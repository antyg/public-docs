...
The separate [`compliance/`](../../compliance/README.md) domain contains compliance alignment matrices that map framework controls to product capabilities. Use this workflow:
