...
defender-for-cloud/
├── README.md                                    (this file)
├── explanation-security-architecture.md         (CSPM vs CWPP, Defender plans, E5 integration)
├── explanation-threat-protection-methodology.md (detection philosophy, signals, alert correlation)
├── how-to-getting-started.md                    (enable Defender for Cloud, first recommendations)
├── how-to-configure-workload-protection.md      (enable Defender plans per workload type)
├── how-to-compliance-and-governance.md          (regulatory compliance dashboard, E8, ISM, policies)
├── how-to-troubleshoot-common-issues.md         (troubleshooting common Defender for Cloud issues)
├── reference-api-and-automation.md              (REST API, Azure Policy, Logic Apps, PowerShell)
├── reference-pricing-and-licensing.md           (Defender plan pricing, SKU comparison, E5 value)
├── config/
