...
| ---------------------------------------------- | -------------------------------------------------------------------------------------- | ----------- | ------------ |
| Portal Overlap, Boundaries, and GPO Precedence | [explanation-ocps-portal-overlap-and-gpo-precedence.md](explanation-ocps-portal-overlap-and-gpo-precedence.md) | Explanation | ✅ Published |

---

## Cross-References

- **Intune administrators** encountering OCPS in the Intune console: see [Intune — OCPS Cross-Reference](../../endpoints/intune/reference-ocps-cross-reference.md)
