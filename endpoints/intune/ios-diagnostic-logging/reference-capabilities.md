---
title: "Capabilities and Sources — iOS/iPadOS Diagnostic Logging"
status: "published"
...
| Something isn't working as expected in any of the above | [Troubleshooting Tips](how-to-troubleshoot-diagnostic-logging.md) | Any |
...
- [Concepts and Architecture](reference-concepts.md)
- [Platform Limits and Caveats](reference-limits-and-caveats.md)
- [Diagnostic Data Scope](reference-data-scope.md)
