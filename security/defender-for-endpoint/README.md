...
├── explanation/
│   ├── README.md
│   └── validation-methods-overview.md    (comparison of all 7 validation methods)
├── tutorials/
│   ├── README.md
│   ├── powershell-validation.md          (step-by-step local and remote PowerShell validation)
│   └── graph-api-validation.md           (step-by-step Graph Security API inventory tutorial)
├── how-to/
│   ├── README.md
│   ├── console-validation.md             (portal-based verification via Microsoft Defender portal)
│   └── advanced-hunting-kql.md           (KQL queries for deployment verification and hunting)
├── reference/
│   ├── README.md
│   ├── registry-service-reference.md     (registry keys, service names, event IDs)
│   ├── wmi-cim-reference.md              (WMI class schemas, CIM query patterns)
│   └── client-analyzer.md               (MDE Client Analyzer tool reference)
├── scripts/
│   └── README.md                         (index of PowerShell automation scripts)
└── workbooks/
    └── README.md                         (Azure Workbook deployment and usage guide)
```
