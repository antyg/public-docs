...
For Intune-specific policy documentation, see: [Intune — Policies for Microsoft 365 Apps (Cross-Reference)](../../endpoints/intune/reference-ocps-cross-reference.md)
...
- [Intune — OCPS Cross-Reference](../../endpoints/intune/reference-ocps-cross-reference.md) — stub document directing Intune administrators to this explanation
