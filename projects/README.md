...
- **modernisation-assessment/** — Technology stack modernisation assessment resources including the [SCCM-to-Intune transition assessment](modernisation-assessment/sccm-to-intune/) (14 documents, 10 capability areas, 200+ feature comparisons), [capability assessment template](modernisation-assessment/reference-capability-assessment-template.md), and [discovery questionnaire](modernisation-assessment/reference-sccm-to-intune-discovery-questionnaire.md)
- **future-projects/** — [Framework](future-projects/) for planning and documenting future project initiatives, including project lifecycle model, assessment methodology, and quality gates
