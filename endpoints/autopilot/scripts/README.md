---
title: "Windows Autopilot Templates"
status: "published"
...
- **[Deploy Windows Autopilot](../how-to-deploy-autopilot.md)** — Implementation procedures using templates
- **[Troubleshoot Windows Autopilot](../how-to-troubleshoot.md)** — Diagnostic template applications
- **[Cloud Migration Assessment](../reference-cloud-migration-assessment.md)** — Migration-specific template usage
- **[Hybrid Deployment Limitations](../reference-limitations.md)** — Platform constraints and workarounds
