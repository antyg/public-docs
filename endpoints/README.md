...
| [`chrome-os/`](chrome-os/README.md)               | ChromeOS                             | 📋 Planned                                           |
| [`macos/`](macos/README.md)                       | macOS                                | Seeded — explanation + reference outlines (planned)   |
| [`windows/`](windows/README.md)                   | Windows 10 / 11                      | Seeded — explanation + reference outlines (planned)   |
| [`virtual-machines/`](virtual-machines/README.md) | Azure VMs, Hyper-V, AVD, Windows 365 | Seeded — explanation + reference outlines (planned)   |
...
| Folder                              | Tool                   | Status                                          |
| ----------------------------------- | ---------------------- | ----------------------------------------------- |
| [`autopilot/`](autopilot/README.md) | Windows Autopilot      | Draft — 8 Diataxis files + 11 scripts migrated from legacy  |
| [`intune/`](intune/README.md)       | Microsoft Intune (MEM) | Draft — `ios-diagnostic-logging/` published + 2 new files   |
...
**Maintainer**: antyg
**Status**: Active — Autopilot migration complete, Intune expanded, Windows/macOS/VM seeds created
